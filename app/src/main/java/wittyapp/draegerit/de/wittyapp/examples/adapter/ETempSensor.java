...
public enum ETempSensor {
    SHT30(R.string.sht30, R.drawable.esp12smal, EAction.SHT30),
    DS18B20(R.string.ds18b20, R.drawable.esp12smal, EAction.DS18B20),
    DHT11(R.string.dht11, R.drawable.esp12smal, EAction.DHT11),
    DHT22(R.string.dht22, R.drawable.esp12smal, EAction.DHT22);
